...
// Here I created the manager while asking for their name, id, email, and office number.
const createManager = () => {
    inquirer.prompt([
        {
            type: 'input',
    ...
    // Assigns answers to new Manager object
      .then((answers) => {
...
// Generates the HTML to the HTML folder
const createHTML = (employeesHtml) => {
    console.log("\nGoodbye!");
    return fs.writeFile('./HTML/index.html', generateHTML(employeesHtml), (err) => 
